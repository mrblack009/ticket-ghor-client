  ...
  const {
   ...
   const onSubmit = async (data) => {
    try {
      ...
      // send to backend
       const axRes = await addUsers(rest);
       console.log(axRes);
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 text-left">
            ...
            <div>
              ...
              <input
                ...
                className={`w-full bg-transparent border-b ${
                  errors.name ? 'border-red-500' : 'border-secondary focus:border-blue-500'
            ...
            <div>
              ...
              <input
                ...
                className={`w-full bg-transparent border-b ${
                  errors.email ? 'border-red-500' : 'border-secondary focus:border-blue-500'
                } py-2 text-secondary placeholder-slate-600 focus:outline-none transition-colors text-sm`}
                {...register('email', { 
            ...
            <div>
              ...
              <input
                ...
                className={`w-full bg-transparent border-b ${
                  errors.password ? 'border-red-500' : 'border-secondary focus:border-red-400'
                } py-2 text-secondary placeholder-slate-600 focus:outline-none transition-colors text-sm`}
                {...register('password', { 
            ...
            {errors.agreeTerms && (
              <p className="text-red-500 text-xs mt-0">{errors.agreeTerms.message}</p>
            )}
